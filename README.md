...
###
<p align="left">Занимаюсь бэкенд-разработкой, люблю разбираться в том, как всё устроено «под капотом». 
Студент НКСЭ  "Информационные системы и программирование"
Есть база на C++, поэтому в Python пишу осознанно: понимаю работу памяти, сетевых протоколов и потоков. Мне интересно работать с нагрузкой и сетью, а не просто перекладывать данные из одной таблицы в другую.<br><br>- 📚 Завершил курсы по разработке на C++ от школы Skillfactory!<br>- ⚡ Завершил курсы по разработке на Python от Яндекс Практикум!<br>- 🔭 Принимал участие в хакатоне от ВТБ.</p>
...
- [Асинхронный сетевой сканер](https://github.com/spbfedor/NetworkSecurityAuditScanner.git)
